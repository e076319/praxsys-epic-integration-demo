/* PraxSys Epic Integration Demo V1.1 - Epic Sandbox SMART on FHIR bootstrap */
(function(){
  'use strict';
  const CONFIG = {
  ...
  async function loadEpicContext(client){
    ...
    if(patientId){
      try{ lda=await client.request(`Observation?patient=${encodeURIComponent(patientId)}`); }
  ...
  function loadPraxSys(ctx){
    ...
    s.src='assets/app.86a9de1a1e.js';
