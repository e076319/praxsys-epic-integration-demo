...
(function () {
  ...
  function epicLdaEntries(){const ctx=window.PRAXSYS_EPIC_CONTEXT||{};const all=(ctx.lda&&Array.isArray(ctx.lda.entry))?ctx.lda.entry:[];return all.filter(e=>e&&e.resource&&e.resource.resourceType==='Observation');}
