...
(function () {
  ...
  function epicLdaEntries(){const ctx=window.PRAXSYS_EPIC_CONTEXT||{};const entries=(ctx.lda&&Array.isArray(ctx.lda.entry))?ctx.lda.entry:[];return entries.filter(e=>e&&e.resource&&e.resource.resourceType==='Observation');}
