...
(function () {
  ...
  document.getElementById('resetDemoButton').onclick=()=>{try{sessionStorage.clear();}catch(e){} window.location.replace(window.PRAXSYS_EPIC_CONFIG&&window.PRAXSYS_EPIC_CONFIG.redirectUri?window.PRAXSYS_EPIC_CONFIG.redirectUri:(window.location.origin+window.location.pathname));};render();
})();;
